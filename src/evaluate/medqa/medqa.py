...
label_correct = 0
total = 0
file_path="medqa_testset.jsonl"
csv_output = "medqa_results.csv"
with open(csv_output, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    with open(file_path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            question = item["finalq"]
            options = item["options"]
            correct_letter = item["answer_idx"].strip().upper()
            correct_text = item["answer"].strip().lower()
